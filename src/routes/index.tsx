...
const FAQ_SCHEMA = {
  ...
  mainEntity: [
    ...
    { "@type": "Question", name: "A Pluma só faz transmissão ou também produz o evento presencial?", acceptedAnswer: { "@type": "Answer", text: "A Pluma é produtora audiovisual focada em transmissão e captação, e traz parceiros de confiança para produzir o evento físico: cenografia, catering, hospitalidade, RSVP e demais frentes de produção." } },
    ...
    { "@type": "Question", name: "É possível usar a gravação do live streaming para cortar conteúdo depois?", acceptedAnswer: { "@type": "Answer", text: "Sim. A entrega da gravação em qualidade master permite usar a captação ao vivo como matéria-prima para teasers, cortes para redes sociais e peças institucionais. A Pluma também oferece essa edição pós-evento como serviço adicional." } },
    { "@type": "Question", name: "A Pluma opera com transmissões privadas ou apenas públicas?", acceptedAnswer: { "@type": "Answer", text: "Os dois formatos. Transmissões em plataformas públicas como YouTube, Instagram e LinkedIn, e em ambientes privados como Vimeo OTT, plataformas corporativas, sites com login e eventos restritos por convite. Para conteúdo confidencial, o stream é configurado com a segurança necessária." } },
    { "@type": "Question", name: "E se o evento atrasar ou estender o horário?", acceptedAnswer: { "@type": "Answer", text: "A proposta cobre uma duração estimada com margem de tolerância. Se o evento se estender significativamente além do previsto, há uma hora adicional combinada previamente. Todas as condições ficam explícitas na proposta antes do fechamento." } },
    { "@type": "Question", name: "É possível contratar apenas a captação, sem transmissão ao vivo?", acceptedAnswer: { "@type": "Answer", text: "Sim. A Pluma faz captação multicâmera e entrega o material editado ou bruto, sem necessidade de stream ao vivo. É um serviço comum para eventos em que a transmissão não é necessária mas o conteúdo precisa virar peça depois." } },
    ...
    { "@type": "Question", name: "O que está incluído no orçamento da Pluma?", acceptedAnswer: { "@type": "Answer", text: "A proposta inclui equipe técnica completa (direção, operadores e assistentes conforme o porte, com comunicação sem fio), equipamentos (câmeras, áudio, switcher, encoder), iluminação, internet redundante, configuração das plataformas de streaming e arquivos de gravação master ao fim do evento. Itens variáveis como cenografia, teleprompter, tradução simultânea ou deslocamento para outras cidades são listados separadamente na proposta." } },
    { "@type": "Question", name: "Como funciona o pagamento na Pluma?", acceptedAnswer: { "@type": "Answer", text: "A Pluma trabalha com 50% de sinal na confirmação do projeto e 50% até o dia do evento. Para clientes recorrentes ou eventos de maior porte, é possível negociar diferentes condições. A nota fiscal é emitida em nome da Pluma." } },
    { "@type": "Question", name: "A Pluma tem portfólio de transmissões para mostrar?", acceptedAnswer: { "@type": "Answer", text: "Sim. Como nem toda transmissão pode ser compartilhada publicamente, por confidencialidade do cliente ou contrato, o portfólio de live streaming é apresentado em conversa, conforme o tipo de evento planejado." } },
  ],
};
